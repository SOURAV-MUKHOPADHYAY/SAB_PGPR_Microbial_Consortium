...
Machine learning techniques were employed to predict the impact of transcription factors on gene expression on day 18, using R for both modeling and visualization. Linear models were avoided due to assumption violations, as noted in:
